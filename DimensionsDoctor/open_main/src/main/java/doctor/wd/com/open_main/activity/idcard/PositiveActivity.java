package doctor.wd.com.open_main.activity.idcard;
...
import doctor.wd.com.open_main.activity.idcard.util.DisplayUtil;
import doctor.wd.com.open_main.activity.idcard.util.UrlUtils;
...
public class PositiveActivity extends Activity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        idCardPresenter = new IdCardPresenter(new idCall());
    ...
    private class idCall implements Cinterface<DataBean> {
        @Override
        public void success(DataBean data, Object... args) {
            UIUtils.showToastSafe("成功---身份证");
        }

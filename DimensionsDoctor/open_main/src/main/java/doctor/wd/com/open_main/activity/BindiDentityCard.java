...
import doctor.wd.com.open_main.activity.idcard.CameraScanActivity;
import doctor.wd.com.open_main.presenter.IdCardPresenter;
import okhttp3.RequestBody;

public class BindiDentityCard extends AppCompatActivity {
...
//        tv_id_number.setText(id_number);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bindi_dentity_card);
        ...
        idCardPresenter = new IdCardPresenter(new BindDectorldCallBack());
        context = this;
...
//        iv_bank = (ImageView) findViewById(R.id.iv_bank);
        ...
        card_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    idCardPresenter.reqeust(id,sessionId
                            ,requestBody
                    );
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private class BindDectorldCallBack implements Cinterface<DataBean> {
        @Override
        public void success(DataBean data, Object... args) {
            UIUtils.showToastSafe("身份证");
        }
